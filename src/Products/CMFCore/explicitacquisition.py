...
PUBLISHABLE_THROUGH_ACQUISITION =  os.environ.get("ALLOW_CONTENT_PUBLISHABLE_THROUGH_ACQUISITION", "false") == "true"

@adapter(IPubAfterTraversal)
def after_traversal_hook(event):
    if  PUBLISHABLE_THROUGH_ACQUISITION or IPublishableThroughAcquisition.providedBy(event.request):
        return
